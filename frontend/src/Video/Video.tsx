    ...
    <div className="docs-page">
      ...
      <nav className="navbar" style={{ width: '100%', marginBottom: '24px' }}>
        ...
        <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
          ...
          <button className="navbar__toggle" onClick={goBack}>
      ...
      <div className="docs-content-wrapper">
        <div className="docs-container">
          <header className="docs-header">
            ...
            <p className="docs-subtitle">A quick video walkthrough of the GitLab Helpdesk AI in action.</p>
          </header>
          ...
          <section className="docs-section">
            <div style={{
              ...
              >
                <source src="/Gitlab_video.mp4" type="video/mp4" />
